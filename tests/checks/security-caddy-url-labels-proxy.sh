...
# =============================================================================
# Caddy URL Labels Check - Proxy Service
# =============================================================================
# GIVEN: Caddy labels should publish the correct HTTPS endpoint for proxy service
...
readonly TEST_ID="caddy_url_labels_proxy"
readonly PASS_MSG="PASS|${TEST_ID}|Proxy service Caddy URL label correct|yq eval '.services.proxy.labels.caddy' docker-compose.yaml"
readonly FAIL_MISSING="FAIL|${TEST_ID}|Proxy service missing Caddy URL label|yq eval '.services.proxy.labels.caddy' docker-compose.yaml"
readonly FAIL_INCORRECT="FAIL|${TEST_ID}|Proxy service Caddy URL label incorrect|yq eval '.services.proxy.labels.caddy' docker-compose.yaml"
...
# WHEN: Get Caddy URL label for proxy service
CADDY_URL=$(yq eval '.services.proxy.labels.caddy' "$COMPOSE_FILE" 2>/dev/null || echo "null")
